...
<0> entry
	...
	store %arrayBase_3 %global2local_18
	...
	store %arrayBase_15 %global2local_16
...
<7> for_step
	%idVal_30 = load %global2local_37
	%oldVal_31 = load %global2local_37
	%newVal_32 = inc %oldVal_31
	store %newVal_32 %global2local_37
	br <5>
...
<3> for_step
	%idVal_33 = load %global2local_36
	%oldVal_34 = load %global2local_36
	%newVal_35 = inc %oldVal_34
	store %newVal_35 %global2local_36
	br <1>
...
<9> centry
	...
	%cidVal_52 = load %global2local_68
...
<15> centry
	...
	%cidVal_61 = load %global2local_68
...
<3> lhs_true
	%arrayBase_8 = load %global2local_70
...
<1> if_true
	...
	%idVal_43 = load %global2local_74
	%res_44 = eq %idVal_42 %idVal_43
	br %res_44 <7> <6>

<7> lhs_true
	%idVal_45 = load %argAddr_3
	%idVal_46 = load %global2local_66
	%res_47 = eq %idVal_45 %idVal_46
	br %res_47 <5> <6>

<5> if_true
	store 1 %global2local_72
	br <6>
...
<2> if_merge
	%tmp_84 = load %global2local_71
	store %tmp_84 @tail
	%tmp_85 = load %global2local_72
	store %tmp_85 @ok
	ret 
...
<22> centry
	...
	store 0 %global2local_252
	store 0 %global2local_240
	...
	store %carrayBase_143 %global2local_249
	store 0 %global2local_246
	br <23>

<23> cfor_cond
	%cidVal_144 = load %global2local_246
...
<27> cfor_step
	%cidVal_167 = load %global2local_248
	%coldVal_168 = load %global2local_248
	%cnewVal_169 = inc %coldVal_168
	store %cnewVal_169 %global2local_248
	br <25>
...
<29> cfor_step
	%cidVal_170 = load %global2local_246
	%coldVal_171 = load %global2local_246
	%cnewVal_172 = inc %coldVal_171
	store %cnewVal_172 %global2local_246
	br <23>
...
<21> after_call
	%res_0 = getInt ( )
	store %res_0 %global2local_238
	%idVal_1 = load %global2local_238
	%res_2 = sub %idVal_1 1
	store %res_2 %global2local_242
	%idVal_3 = load %global2local_242
	store %idVal_3 %global2local_251
	store 0 %global2local_246
	br <1>

<1> for_cond
	%idVal_4 = load %global2local_246
	%idVal_5 = load %global2local_238
...
<5> for_cond
	%idVal_7 = load %global2local_248
	%idVal_8 = load %global2local_238
	%res_9 = lt %idVal_7 %idVal_8
	br %res_9 <6> <8>

<6> for_body
	%res_10 = neg 1
	%arrayBase_11 = load %global2local_249
	%idVal_12 = load %global2local_246
	%offset_13 = mul %idVal_12 8
	%elementAddr_14 = add %arrayBase_11 %offset_13
	%arrayBase_15 = load %elementAddr_14
	%idVal_16 = load %global2local_248
	%offset_17 = mul %idVal_16 8
	%elementAddr_18 = add %arrayBase_15 %offset_17
...
<7> for_step
	%idVal_19 = load %global2local_248
	%oldVal_20 = load %global2local_248
	%newVal_21 = inc %oldVal_20
	store %newVal_21 %global2local_248
	br <5>
...
<9> while_cond
	%idVal_81 = load %global2local_252
	%idVal_82 = load %global2local_240
	%res_83 = le %idVal_81 %idVal_82
	br %res_83 <10> <11>

<10> while_body
	%arrayBase_84 = load %global2local_237
	%idVal_85 = load %global2local_252
	%offset_86 = mul %idVal_85 8
	%elementAddr_87 = add %arrayBase_84 %offset_86
	%elementVal_88 = load %elementAddr_87
	store %elementVal_88 %global2local_247
	%arrayBase_89 = load %global2local_250
	%idVal_90 = load %global2local_252
	%offset_91 = mul %idVal_90 8
	%elementAddr_92 = add %arrayBase_89 %offset_91
	%elementVal_93 = load %elementAddr_92
	store %elementVal_93 %global2local_244
	%arrayBase_94 = load %global2local_249
	%idVal_95 = load %global2local_247
	%offset_96 = mul %idVal_95 8
	%elementAddr_97 = add %arrayBase_94 %offset_96
	%arrayBase_98 = load %elementAddr_97
	%idVal_99 = load %global2local_244
	%offset_100 = mul %idVal_99 8
	%elementAddr_101 = add %arrayBase_98 %offset_100
	%elementVal_102 = load %elementAddr_101
	store %elementVal_102 %global2local_239
	store 0 %global2local_248
	br <12>

<12> for_cond
	%idVal_103 = load %global2local_248
	%res_104 = lt %idVal_103 8
	br %res_104 <13> <15>

<13> for_body
	%idVal_105 = load %global2local_247
	%arrayBase_106 = load %global2local_245
	%idVal_107 = load %global2local_248
	...
	%idVal_112 = load %global2local_244
	%arrayBase_113 = load %global2local_243
	%idVal_114 = load %global2local_248
...
<41> centry
	...
	%cidVal_223 = load %global2local_238
...
<47> centry
	...
	%cidVal_232 = load %global2local_238
...
<34> clhs_true
	%carrayBase_179 = load %global2local_249
...
<35> cif_true
	%cidVal_190 = load %global2local_240
	%coldVal_191 = load %global2local_240
	%cnewVal_192 = inc %coldVal_191
	store %cnewVal_192 %global2local_240
	%cidVal_193 = load %cargAddr_174
	%carrayBase_194 = load %global2local_237
	%cidVal_195 = load %global2local_240
	...
	%carrayBase_199 = load %global2local_250
	%cidVal_200 = load %global2local_240
	%coffset_201 = mul %cidVal_200 8
	%celementAddr_202 = add %carrayBase_199 %coffset_201
	store %cidVal_198 %celementAddr_202
	%cidVal_203 = load %global2local_239
	%cres_204 = add %cidVal_203 1
	%carrayBase_205 = load %global2local_249
...
<14> for_step
	%idVal_119 = load %global2local_248
	%oldVal_120 = load %global2local_248
	%newVal_121 = inc %oldVal_120
	store %newVal_121 %global2local_248
	br <12>

<15> for_end
	%idVal_122 = load %global2local_241
...
<17> if_merge
	%idVal_124 = load %global2local_252
	%oldVal_125 = load %global2local_252
	%newVal_126 = inc %oldVal_125
	store %newVal_126 %global2local_252
	br <9>

<11> while_end
	%idVal_127 = load %global2local_241
	%res_128 = eq %idVal_127 1
	br %res_128 <18> <19>

<18> if_true
	%arrayBase_129 = load %global2local_249
	%idVal_130 = load %global2local_251
	%offset_131 = mul %idVal_130 8
	%elementAddr_132 = add %arrayBase_129 %offset_131
	%arrayBase_133 = load %elementAddr_132
	%idVal_134 = load %global2local_242
...
<20> if_merge
	%tmp_269 = load %global2local_238
	store %tmp_269 @N
	%tmp_270 = load %global2local_239
	store %tmp_270 @now
	%tmp_271 = load %global2local_240
	store %tmp_271 @tail
	%tmp_272 = load %global2local_241
	store %tmp_272 @ok
	%tmp_273 = load %global2local_242
	store %tmp_273 @targety
	%tmp_274 = load %global2local_244
	store %tmp_274 @y
	...
	store %tmp_278 @step
	%tmp_279 = load %global2local_251
	store %tmp_279 @targetx
	%tmp_280 = load %global2local_252
	store %tmp_280 @head
	ret 0
