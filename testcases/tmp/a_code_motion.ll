...
<1> while_cond
	%varDef_43 = phi <0> 0 <2> %newVal_27
	%varDef_44 = phi <0> 0 <2> %res_24
...
<8> after_call
	%varDef_107 = phi <10> 0 <11> %cres_61
...
<12> after_call
	%varDef_111 = phi <14> 0 <15> %cres_71
...
<16> after_call
	%varDef_115 = phi <18> 0 <19> %cres_81
...
<20> after_call
	%varDef_120 = phi <22> 0 <23> %cres_91
...
<4> for_cond
	%varDef_122 = phi <20> 0 <5> %newVal_50
...
<24> after_call
	%varDef_128 = phi <26> 0 <27> %cres_101
...
<2> if_merge
	%varDef_64 = phi <7> $str_0 <1> %res_14
	br <3>

<3> for_cond
	%varDef_66 = phi <2> %varDef_64 <4> %res_30
	%varDef_67 = phi <2> 1 <4> %newVal_33
...
<6> for_cond
	%varDef_81 = phi <14> 0 <7> %newVal_39
