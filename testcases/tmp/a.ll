...
<5> if_true
	...
	#println ( %res_6 )
	store 0 %varAddr_8
	%idVal_10 = load %varAddr_8
	%res_9 = #toString ( %idVal_10 )
	#println ( %res_9 )
	store 1 %varAddr_11
	%idVal_13 = load %varAddr_11
...
<3> for_step
	...
	%oldVal_15 = load %varAddr_0
	%newVal_16 = inc %oldVal_15
	store %newVal_16 %varAddr_0
	br <1>
