...
__L_3:
		...
		call    getInt
		mov     %res_16, rax
		mov     %arrayBase_18, %arrayPtr_3
		add     %arrayBase_18, 8
		mov     %elementAddr_21, %arrayBase_18
		add     %elementAddr_21, %offset_14
		mov     qword [%elementAddr_21], %res_16
		mov     %newVal_24, %varDef_56
		inc     %newVal_24
		mov     %alloca_2, %newVal_24
		jmp     __L_1
__L_2:
		mov     %alloca_3, 0
__L_4:
		mov     %varDef_59, %alloca_3
		mov     %classPtr_27, qword [rel _a]
		mov     rdi, %classPtr_27
		call    _arraySize
		mov     %res_26, rax
		cmp     %varDef_59, %res_26
		setl    al
		movzx   %res_28, al
		cmp     %res_28, 0
		je      __L_5
__L_6:
		...
		mov     rdi, %res_29
		call    print
		mov     %newVal_38, %varDef_59
		inc     %newVal_38
		mov     %alloca_3, %newVal_38
		jmp     __L_4
__L_5:
		mov     rdi, __str_0
		call    println
		mov     qword [rel _a], %arrayPtr_3
		mov     %alloca_1, 0
__L_7:
		mov     %varDef_62, %alloca_1
		mov     %classPtr_42, qword [rel _a]
		mov     rdi, %classPtr_42
		call    _arraySize
		mov     %res_41, rax
		cmp     %varDef_62, %res_41
		setl    al
		movzx   %res_43, al
		cmp     %res_43, 0
		je      __L_8
